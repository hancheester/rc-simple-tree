...
var TreeNode = function (_React$Component) {
    ...
    _createClass(TreeNode, [{
        ...
        value: function handleSwitcherClick(event) {
            ...
            var callbackPromise = onNodeExpand(event, this);
            ...
            if (callbackPromise && callbackPromise.then) {
                ...
                callbackPromise.then(function () {
                    ...
                    _this2.setState({ loadStatus: LOAD_STATUS_NONE });
                });
            }
        }
    }, {
        ...
        value: function renderSelector() {
            ...
            if (loadStatus === LOAD_STATUS_LOADING) {
                loadingIcon = _react2.default.createElement('i', { className: 'fa fa-spinner fa-pulse fa-fw' });
            } else {
                loadingIcon = _react2.default.createElement('i', null);
            }
