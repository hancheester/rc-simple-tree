...
var Tree = function (_React$Component) {
    ...
    function Tree(props) {
        ...
        _this.state = {
            expandedIds: (0, _utils.getExpandedIds)(props.children),
            dragOverNodeId: 0,
            dropPosition: null
        };
    ...
    _createClass(Tree, [{
        ...
        value: function renderTreeNode(child, index) {
            ...
            var _child$props = child.props,
                nodeId = _child$props.nodeId,
                isLeaf = _child$props.isLeaf;
        ...
        value: function onNodeDragEnter(event, treeNode) {
            ...
            var dropPosition = (0, _utils.calculateDropPosition)(event, treeNode);
